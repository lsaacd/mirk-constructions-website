...
### [ ] Step 2: Prepare & Finalize Website Code
- [ ] Update company name, phone number, and service areas in `index.html`.
...
- [ ] Create repository (e.g., `dads-contracting-website`).
- [ ] Run Git commands locally:
  ```bash
  git init
  git add .
  git commit -m "Initial website code"
  git remote add origin https://github.com/YOUR_USERNAME/dads-contracting-website.git
  git push -u origin main
  ```

### [ ] Step 4: Connect Vercel Hosting (Auto-Deployment)
- [ ] Create account at [vercel.com](https://vercel.com) using GitHub login.
- [ ] Click **Add New Project** $\rightarrow$ Select `dads-contracting-website` repository.
- [ ] Click **Deploy** to generate initial staging URL (e.g., `dads-contracting.vercel.app`).
